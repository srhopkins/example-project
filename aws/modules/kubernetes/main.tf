...
module "kubernetes" {
  ...
  tectonic_aws_external_master_subnet_ids = ["${module.environment.private_subnets}"]
  ...
  // 
  // Example: `vpc-123456`
  tectonic_aws_external_vpc_id = "${module.environment.vpc_id}"
  ...
  // 
  // Example: `["subnet-111111", "subnet-222222", "subnet-333333"]`
  tectonic_aws_external_worker_subnet_ids = ["${module.environment.private_subnets}"]
  ...
  tectonic_aws_ssh_key = "${module.environment.key_name}"
  ...
  tectonic_aws_vpc_cidr_block = "${module.environment.vpc_cidr_block}"
  ...
  tectonic_base_domain = "steven.hopkins.rocks"
  ...
  tectonic_cluster_name = "${var.env}-${var.region}-${var.name}"
